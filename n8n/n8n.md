...
2. V meniju zgoraj desno kliknite na nastavitve in izberite **Import from File** ter izberite ustrezno JSON datoteko. Lahko pa tudi povsem preprosto kopirate celotno vsebino JSON datoteke in jo prilepite neposredno na delovno površino.
